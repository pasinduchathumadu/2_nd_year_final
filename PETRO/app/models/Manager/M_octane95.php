...
class M_octane95 extends Model{
    ...
    public function add95($data){
        ...
        $sql3 = "update  $this->table1 SET eligible_amount = eligible_amount + $eligible_amount WHERE fuel_id = 'O95' AND fuel_type = 'octane 95'" ;
        ...
        $sql5 = "update  $this->table1 SET remain_amount = remain_amount + $remain_amount WHERE fuel_id = 'O95' AND fuel_type = 'octane 95'";
