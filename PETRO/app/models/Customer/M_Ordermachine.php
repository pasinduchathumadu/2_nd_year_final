...
class M_Ordermachine extends Model
{
    ...
    public function ordermachine($data){
        ...
        $sql2 = "select * from $this->table2  where id= 6";
...
$sql2 = "select * from $this->table2  where id= 7";
  ...
  while($row = $query0->fetch_array()){
      ...
      $phone= $row['phone'];
                ...
                $data=[
                    ...
                    'price_super' => $price_super,
                    'remain_super' => $remain_super,
                    'message'=>"You have previous order to complete",
...
if($amount<=0){
    ...
    $sql6 = "select * from $this->table2  where id= 7";
     ...
     $query22=$result1->query($sql22);
      ...
      while($row = $query22->fetch_array()){
       ...
       $phone= $row['phone'];
                ...
                $sql = "INSERT INTO $this->table1 (id,email,VMno,ftype,amount,points,petropoints) VALUES('$id','$email','$sNo','$ftype','$amount','$points','$petropoints')";
