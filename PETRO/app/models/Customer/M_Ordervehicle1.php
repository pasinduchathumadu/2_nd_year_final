...
class M_Ordervehicle1 extends Model
{
    ...
    public function ordervehicle1($data){
        ...
        $result=$this->connection();
         $sql20 = "select * from $this->table where id='".$id."'";
        $query20=$result->query($sql20);



         if($query20->num_rows>0){
         while($row = $query20->fetch_array()){
             $vno= $row['vno'];
         ...
         $sql22 =  "select * from $this->table6  where vno='".$vno."' AND status=1";
    ...
    public function add($data){
               ...
               /* $id=$_SESSION['id'];
                ...
                $ftype=$_SESSION['vtype'];
                $points=$_SESSION['points'];
                $petropoints=$_SESSION['petropoints'];
