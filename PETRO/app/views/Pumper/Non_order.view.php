        ...
        <main>
                        ...
                        <tbody>
                            <div class="container2">
                                ...
                                <ul class="responsive-table">
                                    <!-- these details are filled by automatically -->
                                    <form action="<?php echo ROOT ?>/Pumper/User/Non_complete" method="post">

                                        <li class="table-row">
                                            <div class="col col-1">
                                                Registerd Phone Number:

                                            </div>

                                            <div class="col col-4">
                                                <label name="no" class="col col-4"><?php echo $data['no'] ?></label>
                                            </div>
                                        ...
                                        <li class="table-row">
                                            ...
                                            <div class="col col-4">
                                                <label name="full" class="col col-4"><?php echo $data['full'] ?></label>
                                            </div>
                                        ...
                                        <li class="table-row">
                                            ...
                                            <div class="col col-4">
                                                <label name="email" class="col col-4"><?php echo $data['email'] ?></label>
                                            </div>
                                            <input type="hidden" name="email" value="<?php echo $data['email'] ?>">
                                        </li>
                                        <!-- pumper has to select these items -->
                                        <li class="table-row">
                                            <div class="col col-1">
                                                Select Vehicle
                                            </div>
                                        ...
                                        if ($data['remark'] == 0) { ?>
                                            <li class="table-row">
                                                ...
                                                <div class="col col-4">
                                                    ...
                                                    <button type="submit" class="btn1">Proceed</button>
                                    ...
                                    <!-- after filling the entered liters -->
                                    <?php
                                    if ($data['remark'] == 1) {
                                    ?>
                                        <li class="table-row">
                                            ...
                                            <div class="col col-4">
                                                <label name="email" class="col col-4"><?php echo $data['price'] ?></label>

                                                <button type="submit" onclick="openForm()" class="btn1">Complete</button>
            ...
            <div class="form-popup" id="myForm">
                <form action="<?php echo ROOT ?>/Pumper/User">
                    <label class="display_message">
                        Your Order has been Successfully Completed!!!
                    </label><br>
                    <button type="submit" class="link">Next Order</button>
                </form>
            </div>
