    ...
    <section id="content">
        ...
        <main>
            ...
            <div class="table-data">
                ...
                <div class="order">
                    <h2>
                        Preveious Monthly Salaries - <?php echo $data['id'] ?>
                    </h2>
                    <br><br><br><br><br>
                ...
                <div class="order">
                    ...
                    <h4 class="middle">
                        Payment Sheet Of <?php echo $data['month'] ?>-<?php echo $data['year'] ?>
                    </h4>
                    ...
                    <ul class="responsive-table">
                        ...
                        <li class="table-row">
                            <div class="col col-1">TOTAL SALARY:</div>

                            <div class="col col-4"><?php echo $v7 ?></div>
                        </li>
                        <form action="<?php echo ROOT ?>/Pumper/Working_salary/previous" method="post">
                            ...
                            <a href='<?php echo ROOT ?>/Pumper/Working_salary/Download?month=<?php echo $data['month']; ?>&year=<?php echo $data['year'] ?>' ;><i class='bx bxs-cloud-download'></i>
