...
<form action="<?php echo ROOT?>/Customer/Updatevehicle3/add" method="POST">
            ...
            <input type="text" name="vno2" value="<?php echo $data['vno2']; ?>" class="box" placeholder="Vehicle No">
			
			<input type="text" name="vtype2" value="<?php echo $data['vtype2']; ?>" class="box">
        
			
			<input type="text" name="ftype2" value="<?php echo $data['ftype2']; ?>" class="box">
