        ...
        <main>
            ...
            <div class="table-data">
                <div class="order">
                    ...
                    <form action="<?php echo ROOT ?>/Customer/Orderticketmachine/add " method="POST">
                        ...
                        <div class="columns">
                            <div class="column">
                                ...
                                <label for="vtype"> Machine Type: </label>
                                <input type="text" name="vtype" value="Any" class="box" readonly><br><br><br>
                            ...
                            <div class="column">
                                ...
                                <input type="text" name="price" value="<?php echo "$price2" ?>" class="box"
                                    readonly><br><br><br>
