                    ...
                    <form action="<?php echo ROOT ?>/Customer/Orderticketvehicle/add " method="POST">
                        ...
                        <div class="columns">
                            <div class="column">
                                ...
                                <input type="hidden" name="email" value="<?php echo $data['email']; ?>" class="box1"
                                    readonly>
                                <label for="orderID"><b> Order ID:</b> </label>
                                <input type="text" name="Oid" value="<?php echo $data['Oid']; ?>" class="box"
                                    readonly><br><br>
                                <br>
                                <label for="vno"> Vehicle No: </label>
                                <input type="text" name="vno" value="<?php echo $data['VMno']; ?>" class="box"
                                    readonly><br><br><br>
                            ...
                            <div class="column">
                                ...
                                <input type="text" name="amount" value="<?php echo $data['amount']; ?>" class="box"
                                    readonly><br><br><br>
                                <label for="cusid"> Price: </label>
                                <input type="number" name="price" value="<?php echo "$price2" ?>" class="box"
                                    readonly><br><br><br>
                                <input type="hidden" name="points" value="<?php echo $data['points']; ?>" class="box"
                                    readonly>
                                <input type="hidden" name="usedpoints" value="<?php echo "$points" ?>" class="box"
                                    readonly>
                                <input type="hidden" name="petropoints" value="<?php echo $data['petropoints']; ?>"
                                    class="box" readonly>


                                <label for="cusid"> Ordered Date: </label>
                                <input type="text" name="cdate" value="<?php echo date("Y/m/d") ?>" class="box"
                                    readonly><br><br><br>
                                <label for="cusid"> Order Expire Date: </label>
                                <input type="text" name="ndate" value="<?php echo "$tomorrow" ?>" class="box"
                                    readonly><br><br><br>
