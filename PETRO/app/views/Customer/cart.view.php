...
<body>
    ...
    <section id="content">
        ...
        <nav>
            ...
            <p>
                <?php echo $_SESSION['CUS_first_name'] ?>
            </p>
                    ...
                    <table>
                        ...
                        <tbody>
                                ...
                                if (mysqli_num_rows($data['result']) > 0) {
                                    while ($row = mysqli_fetch_assoc($data['result'])) {
                                        ...
                                        <tr>
                                            ...
                                            <td><img src="<?php echo ROOT ?>/image/<?php echo $row['image']; ?>" height="50" alt="">
                                            </td>
                                            <td><input class="box5" type="text" value="<?php echo $row['name']; ?>" name="name">
                                            </td>
                                            <td><input type="text" value="Rs.<?php echo $row['price']; ?>" name="price"
                                                    class="box6"></td>

                                            <td>

                                                <input class="box" type="hidden" name="Oid" value="<?php echo $row['Oid']; ?>">
                                                <input class="box" type="hidden" name="user_id"
                                                    value="<?php echo $row['user_id']; ?>">
                                                <input class="box" type="hidden" name="p_id" value="<?php echo $row['p_id']; ?>">

                                                <input class="box6" type="number" min="1" name="quantity"
                                                    value="<?php echo $row['quantity']; ?>" readonly>


                                            </td>

                                            <td><input class="box6" type="text"
                                                    value="<?php echo $sub_total = ($row['price'] * $row['quantity']); ?>"
                                                    name="total"></td>
                                            ...
                                            <td>
                                                ...
                                                <form action="<?php echo ROOT ?>/Customer/Cart/remove " method="POST">
                                                    ...
                                                    <input type="hidden" min="1" name="quantity"
                                                        value="<?php echo $row['quantity']; ?>">
                                                    <button type="submit" class="delete-btn" onclick="">remove</a>
                                            </td>
                            ...
                            <tr class="table-bottom">
                                ...
                                <td>Rs.<input class="box6" type="text" value="<?php echo $grand_total; ?>" name="total">
                                </td>
            ...
            <a href="<?php echo ROOT ?>/Customer/Store" class="store"> <-Store </a>
                                ...
                                <div class="head">
                                    ...
                                    if ($data['count1'] >= 1) {
                                        ...
                                        <div class="address">
                                            ...
                                            <input type="text" value="" name="address" placeholder="address" class="box12"
                                                required max="100"><br><br>
                                            <input type="text" value="" name="phone" placeholder="phone" class="box12"
                                            ...
                                            if ($data['points'] >= 300) { ?><br>
                                                <p class="not"> Your
                                                    <?php echo $data['points']; ?> Points will be reduce from your bill
                                                </p><br>

                                                <input type="hidden" id="points" name="points"
                                                    value="<?php echo $data['points']; ?>">
                                                <input type="hidden" id="points" name="total"
                                                    value="<?php echo $grand_total - $data['points']; ?>">
                                            <?php } else { ?>

                                                <input type="hidden" id="points" name="points" value="0">
                                                <input type="hidden" id="points" name="total"
                                                    value="<?php echo $grand_total ?>"><br>
                    ...
                    <div class="todo">
                        ...
                        <div class="head">
                            ...
                            <p>Returns must be made immediately upon checking the goods on delivery , only if the
                                received goods are either damaged and or wrong product /size subject however to the
                                condition that the product packaging /seal is not broken .
                                Returns shall be handed over to the courier and the refund will be made to the credit
                                card within 7 working days </p>
                        </div>
