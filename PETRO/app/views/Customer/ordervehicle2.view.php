...
?>
        ...
        <form action="<?php echo ROOT ?>/Customer/Ordervehicle2/add " method="POST">
    ...
    <input type="hidden" name="email" value="<?php echo $data['email']; ?>" class="box1" readonly > <br>
     <input type="text" name="vno" value="<?php echo $data['vno1']; ?>" class="box1" readonly><br><br>
 

     <input type="text" name="vtype" value="<?php echo $data['vtype1']; ?>" class="box1" readonly><br><br>


    <?php 
if($data['ftype1']=="petrol"){?>
...
if($data['ftype1']=="diesel"){?>
    ...
    <?php if($data['vtype1']=="car")
   {
    $max= $data['car'];;
   }
    else if($data['vtype1']=="van"){
        $max= $data['car'];;
    }

    else if($data['vtype1']=="threewheel"){
        $max= $data['three'];;
    }

    else if($data['vtype1']=="mcycle"){
        $max= $data['mc'];;
    }
