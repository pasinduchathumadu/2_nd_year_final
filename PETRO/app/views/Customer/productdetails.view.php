...
<head>
    ...
    <!-- My CSS -->
     ...
     <!-- My CSS -->
     <link rel="stylesheet" href="<?php echo ROOT?>/CSS/Customer/productdetails.css" text="text/css">
...
<body>
    ...
    <section id="content">
        ...
        <main>
            ...
            <p class="cart2"> <?php echo $data['count1']?></p>
            <a class="cart" href="<?php echo ROOT ?>/Customer/Cart">
...
<?php  $tomorrow = date("Y/m/d", time() + 86400); ?>
    ...
    <div class="product">
	<form action="<?php echo ROOT ?>/Customer/Productdetails/add " class="box" method="POST">

       <div class="row">
            <div class="column">
                   <div class="img"> <img src="<?php echo ROOT ?>/image/<?php echo $data['image']; ?>" alt="" width="300px"; height="300px"; ></div>
       
        
      
		      <input type="hidden" name="p_id" value="<?php echo $data['p_id']; ?>">
              <input type="hidden" name="product_image" value="<?php echo $data['image']; ?>">
		      ...
		      <input type="hidden" name="cdate" value="<?php echo date("Y/m/d") ?>" class="box" readonly >
		  	  <input type="hidden" name="ndate" value="<?php echo "$tomorrow" ?>" class="box" readonly><br><br>

              <div class="price">Rs.<?php echo $data['price']; ?>/=</div>
              <input type="hidden" name="dis" value="<?php echo $data['description']; ?>">
              ...
              <div class="column">
                  <div class="col1">
                    ...
                    <p class="pd"><?php echo $data['description']; ?></p><br>
    </div>

<br><br>
                  
                  <input type="number" min="1" value="1"name="product_quantity" class="input2">
