                ...
                <div class="container">
                    ...
                    <div class="product">
                        <form action="<?php echo ROOT ?>/Customer/Productdetails/add " class="box" method="POST">
                            ...
                            <div class="row">
                                <div class="column">
                                    <div class="img"> <img src="<?php echo ROOT ?>/image/<?php echo $data['image']; ?>"
                                            alt="" width="300px" ; height="300px" ;></div>
                                    ...
                                    <input type="hidden" name="cdate" value="<?php echo date("Y/m/d") ?>" class="box"
                                        readonly>
                                    <input type="hidden" name="ndate" value="<?php echo "$tomorrow" ?>" class="box"
                                        readonly><br><br>
