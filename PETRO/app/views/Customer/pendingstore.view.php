                            ...
                            if (mysqli_num_rows($data['result3']) > 0) {
                                while ($row = mysqli_fetch_assoc($data['result3'])) {
                                    ...
                                    <tr>
                                        ...
                                        <td><input type="text" value="<?php echo $row['amount']; ?>" name="amount" class="box6">
                                        </td>
                                        <td><input type="text" value="Rs.<?php echo $row['price']; ?>" name="price" class="box6">
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            <form action="<?php echo ROOT ?>/Customer/Pendingstore/remove" method="post">
                                                ...
                                                <button type="submit" class="dbtn2">Cancel</a>
                                        </td>
