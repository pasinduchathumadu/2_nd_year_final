...
<body>
    <div class="Section_top">
        ...
        <div class="wrapper">
            ...
            <form action="<?php echo ROOT ?>/Customer/Register/register" method="post" enctype="multipart/form-data"
                ...
                <input type="tel" name="phone" placeholder="enter phone number (070xxxxxxx)" class="box" required
                    pattern="[0-9]{10}"><br><br>

                <input type="text" name="NIC" placeholder="enter NIC" class="box">
                ...
                <input type="password" name="password" placeholder="enter password"
                    pattern="(?=.*\d)(?=.*[a-z])(?=.*[A-Z]).{8,}" class="box" min="8" required>
                ...
                <br><br>
                <input type="checkbox" id="checkme" /> I agree to <a href="<?php echo ROOT ?>/Customer/Terms"
                    class="login"> Terms & Conditions </a> <br><br>
