    ...
    <section id="content">
        ...
        <main>
            <div class="table-data">
                <div class="order">
                    <!-- view of the email structure -->
                    <form method="POST" action="<?php echo ROOT ?>/Admin/Dis_Send">
                        <h2>Gmail Sender App</h2><br>
                        Email To :<br>
                        <input type="text" name="email" value="<?php echo $data['email'] ?>" readonly="readonly"><br>
                        Subject :<br>
                        <input type="text" name="subject" placeholder="Account Details" readonly="readonly"><br>
                        Body :<br>
                        <textarea name="message" style="height:250px">Hi <?php echo $data['first'] ?><?php echo " ", $data['last'] ?>&#013;
            Your Manger ID:<?php echo $_SESSION['distribution_manager_id'] ?>&#013;
            ...
            <!-- send the email -->
                        <a href="<?php echo ROOT ?>/Admin/Dis_Send"><button type="submit" value="SEND" name="submit" class="btn">SEND</button></a><br>
                        <br>
                        <!-- not send the email -->
