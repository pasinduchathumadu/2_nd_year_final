...
<div class="wrapper">
        <form method="POST" action="<?php echo ROOT?>/Admin/Dis_Send">
            ...
            Email To :<br>
            <input type="email" name="email" value="<?php echo $data['email'] ?>" readonly="readonly" style="width:55%"><br>
            Subject :<br>
            ...
            <input type="submit" value="SEND" name="submit"><a href="<?php echo ROOT?>/Admin/Dis_Send"<br>
        </form><br>
