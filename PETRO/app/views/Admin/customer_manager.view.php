    ...
    <section id="content">
        ...
        <main>
            <div class="head-title">
                <h2>Customer Manager - Registration</h2>
            </div>
...
<!-- staff manager registration form -->
                            <div class="form-inner">
                                <img src="<?php echo ROOT ?>/image/Manager/businessman.png" alt="" style="width:150px;height:300px;">
                                <form action="<?php echo ROOT ?>/Admin/Customer_manager/register" method="POST">
                                    <div class="field">
                                        <input type="email" class="box" name="customer_manager_email" placeholder="Email" required>
                                    </div>
                                    <div class="field">
                                    ...
                                    <div class="field">
                                        <input type="text" class="box" name="customer_manager_NIC" placeholder="NIC" minlength="10" required>
                                    </div>
                                    <div class="field">
                                    ...
                                    <br>
                                    <button type="submit" name="OK" id="ok" class="btn">Create Account</button><br>
