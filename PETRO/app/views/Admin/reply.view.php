<!-- this is the response file of the area -->
<!DOCTYPE html>
<html lang="en">
        ...
        <main>
            ...
            <div class="table-data">
                <div class="order">
                    ...
                    <form action="<?php echo ROOT ?>/Admin/Complain/register" method="post">

                        <label for="fname">Complain ID</label>
                        <input type="text" id="fname" name="complain_ID" value="<?php echo $data['id']?>" placeholder="COM <?php echo $data['id']?>" readonly>
                    ...
                    <!-- store the above details to the database -->
                    </div>
