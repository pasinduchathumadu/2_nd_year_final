                                ...
                                <div class="wrapper">
                                    <div class="form-container">
                                        ...
                                        <div class="form-inner">
                                            <img src="<?php echo ROOT ?>/image/Manager/businessman.png" alt="" style="width:200px;height:200px;" class="proimg">
                                            <form action="<?php echo ROOT ?>/Admin/View_cus/remove" method="POST">

                                                <div class="field">
                                                    <input type="email" class="box" name="manager_email" value="Email: <?php echo $email ?>" readonly>
                                                </div>
                                                <div class="field">
                                                ...
                                                <div class="field">
                                                    <input type="text" class="box" name="phone" value="Phone:<?php echo $phone ?>" readonly>
                                                </div>
                                                <br><br>
                                                <div class="left">
